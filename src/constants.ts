...
export const validateAndTransformEnvVariables = (env: Record<string, string>) => {
  ...
  const envVariables: EnvironmentVariables = {
    ...
    alchemyJsonRpcEthArbitrum: env.alchemyJsonRpcEthArbitrum,
    alchemyJsonRpcEthOptimism: env.alchemyJsonRpcEthOptimism,
    alchemyJsonRpcEthBase: env.alchemyJsonRpcEthBase,
    alchemyJsonRpcEthPolygonZkevm: env.alchemyJsonRpcEthPolygonZkevm,
